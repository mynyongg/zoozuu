...
<%
	...
	boolean rightCode = SHA256.getEncrypt("mynyongg@naver.com", "cos").equals(code) ? true : false;

	PrintWriter script = response.getWriter();
	if (rightCode == true) {
		//DB에 emailCheck 칼럼 update 해주기 1 : 인증완료, 0 : 미인증
		UserDao dao = new UserDao();

		int result = dao.updateEmailAuth("mynyongg@naver.com");
		if (result != 0) {
