				...
				<div class="container box_1620">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						...
						<c:when test = "${empty sessionScope.user.userProfile}">
								...
								<li class="nav-item">
								<a href="/blog/test/uploadForm.jsp">
								<img src="/blog/img/profile-default.png" style="width:40px; height:40px;"/>
								</a></li></ul>				
						</c:when>
						<c:otherwise>
						<ul class="nav navbar-nav navbar-right header_social ml-auto">
							<li class="nav-item"><a href="/blog/test/uploadForm.jsp"><img src="${sessionScope.user.userProfile }" style="width:40px; height:40px;"/></a></li>
						</ul>
						</c:otherwise>
						</c:choose>						
					</div>
